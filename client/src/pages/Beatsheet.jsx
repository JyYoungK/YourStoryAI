...
const Beatsheet = ({ plotData, setPlotData }) => {
  ...
  return (
    <div className="mb-5 text-center">
      ...
      <form className="border-gray-400 rounded-lg border-2 p-6 dark:border-white">
        {mainFields.map((field) => (
          <div className="mb-5 flex flex-col text-center" key={field.name}>
            <label className="mb-2 text-xl font-medium">{field.name}</label>
            <div className="flex flex-row items-center justify-center text-lg">
              <input
                ...
                className={`form-input text-gray-700 border-gray-400 w-2/3 rounded-md border-2 bg-white py-2 leading-5 focus:bg-white dark:border-white dark:bg-night dark:text-white `}
              />
        ...
        <label className="block text-center text-xl font-medium">
          Story Type
        </label>
          ...
          <div className="mb-5" key={field.name}>
            ...
            <div className="flex flex-row text-lg">
              <textarea
                ...
                onChange={(event) => field.onChange(event)}
                placeholder={field.placeholder}
                className={`text-gray-700 border-gray-400 text-wrap h-44 w-full overflow-x-hidden rounded-md border-2 bg-white py-2 px-3 leading-5 focus:bg-white
